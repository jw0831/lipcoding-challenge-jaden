...
class TestMatchingRequests:
    ...
    def test_create_request_as_mentee(self, client, app):
        ...
        response = client.post('/api/match-requests',
                             data=json.dumps({
                                 'mentor_id': mentor_id,
    ...
    def test_get_requests_as_mentee(self, client, app):
        ...
        client.post('/api/match-requests',
                   data=json.dumps({
                       'mentor_id': mentor_id,
    ...
    def test_accept_request_as_mentor(self, client, app):
        ...
        # Accept as mentor
        mentor_headers = get_auth_headers(client, 'mentor@test.com', 'password123')
        response = client.put(f'/api/match-requests/{request_id}',
    ...
    def test_delete_request_as_mentee(self, client, app):
        ...
        # Delete as mentee
        response = client.delete(f'/api/match-requests/{request_id}', headers=mentee_headers)
...
class TestSecurity:
    ...
    def test_sql_injection_protection(self, client, app):
        ...
        assert response.status_code in [400, 401]  # Bad request or unauthorized, not 500
