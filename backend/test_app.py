...
class TestMentorListing:
    ...
    def test_get_mentors_as_mentee(
        self, client, mentor_user, mentee_user, auth_headers_mentee
    ):
    ...
    def test_get_mentors_with_skill_filter(
        self, client, mentor_user, mentee_user, auth_headers_mentee
    ):
...
class TestMatchingRequests:
    ...
    def test_create_request_as_mentee(
        self, client, mentor_user, mentee_user, auth_headers_mentee
    ):
        ...
        response = client.post(
            "/api/requests",
            data=json.dumps(
                {"mentorId": mentor_user.id, "message": "I would like mentoring"}
            ),
            content_type="application/json",
    ...
    def test_create_request_as_mentor_fails(
        self, client, mentor_user, mentee_user, auth_headers_mentor
    ):
        """Test that mentors cannot create requests"""
        response = client.post(
            "/api/requests",
            data=json.dumps(
                {"mentorId": mentee_user.id, "message": "This should fail"}
            ),
            content_type="application/json",
            headers=auth_headers_mentor,
        )
    ...
    def test_get_requests_as_mentee(
        self, client, mentor_user, mentee_user, auth_headers_mentee
    ):
    ...
    def test_get_requests_as_mentor(
        self, client, mentor_user, mentee_user, auth_headers_mentor
    ):
    ...
    def test_accept_request_as_mentor(
        self, client, mentor_user, mentee_user, auth_headers_mentor
    ):
    ...
    def test_delete_request_as_mentee(
        self, client, mentor_user, mentee_user, auth_headers_mentee
    ):
        ...
        response = client.delete(
            f"/api/requests/{request_id}", headers=auth_headers_mentee
        )
